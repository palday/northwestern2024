---
title: "Using your mixed models to the fullest: moving beyond ANOVA-style thinking (in EEG analyses)"
format: revealjs
author:
    name: Phillip Alday
...
- Got a hypothesis that A != B? Test that!
- Got a hypothesis that A > B and A > C, but don't care much about the relationship beween B and C? Test that! 
...
- ANOVA forces discrete thinking, both in terms of signifance and in terms of predictors
