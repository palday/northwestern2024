...
## Treat population-/group-level and individual analyses holisticallym

* in addition to the fixed effects, i.e. "population-level" estimates, ixed models also provide predictions about the individual grouping levels
